...
#=====================================================================#
{
  ...
  fetch = "fastfetch"; # neofetch, nerdfetch, pfetch, fastfetch
in {
  #--------------------------------------------------------------------#
  ...
  programs.zsh = {
    ...
    initContent = lib.mkBefore ''
      ...
      # Default to nixos-config directory on new shells
      [[ "$PWD" == "$HOME" ]] && cd ~/nixos-config
      ...
      # Jump to a directory using fd + fzf
      function fcd() {
        local dir
